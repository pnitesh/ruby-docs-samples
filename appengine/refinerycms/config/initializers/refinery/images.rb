...
Refinery::Images.configure do |config|
  ...
  # config.datastore_root_path = "/usr/local/google/home/franknatividad/Git-Repositories/ruby-docs-samples/appengine/refinerycms/public/system/refinery/images"
